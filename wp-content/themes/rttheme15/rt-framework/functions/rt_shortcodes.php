...
$contact_form.= "".    
	...
	'		<ul>'.
	'			<li><label for="name">'.__('Votre Nom: (*)','rt_theme').'</label><input id="name" type="text" name="name" value="" class="required" /> </li>'.
	'			<li><label for="email">'.__('Votre E-mail: (*)','rt_theme').'</label><input id="email" type="text" name="email" value="" class="required email" /> </li>'.
	...
	'			<li><label for="message">'.__('Votre message (*)','rt_theme').'</label><textarea  id="message" name="message" rows="8" cols="40"	class="required"></textarea></li>'.
	'			<li>'.
	'			<input type="hidden" name="your_email" value="'.trim($atts['email']).'">'.
	'			<input type="hidden" name="your_web_site_name" value="'.get_bloginfo('name').'">'.
	
	'			<input type="hidden" name="text_1" value="'.__('Merci','rt_theme').'">'.
	'			<input type="hidden" name="text_2" value="'.__('Votre message a été envoyé avec succès. Nous vous recontacterons bientôt.','rt_theme').'">'.
	'			<input type="hidden" name="text_3" value="'.__('Une erreur est survenue.','rt_theme').'">'.
	'			<input type="hidden" name="text_4" value="'.__('Merci d\'entrer une adresse e-mail valide.','rt_theme').'">'.
	
	'			<input type="submit" class="button" value="'.__('Envoyer','rt_theme').'"  /><span class="loading"></span></li>'.
	'		</ul>'.
	'	</form>'.
